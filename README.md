...
4. Follow the rest of the lerobot installation instructions, working inside of your virtual env.
...
Assuming that you have the conda environment and the repositories, simply run `conda activate lerobot`
...
CAMERAS="top_realsense_color top_realsense_depth wrist_right wrist_left top_webcam" #total five cameras that you can include/exclude
